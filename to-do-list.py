...
listbox_tasks = tk.Listbox(window, height=5, width=100, bg="lightblue",font=('Arial',12))
...
button_add_task = tk.Button(window, text="Add Task", width=10, command=add_task,bg='blue',font=('Arial',12))
...
button_delete_all_tasks = tk.Button(window, text="Delete All Tasks", width=15, command=delete_all_tasks,bg='red',font=('Arial',12))
...
button_mark_complete = tk.Button(window, text="Mark Complete", width=12, command=mark_complete,bg='green',font=('Arial',12))
button_mark_complete.pack(pady=5)


button_save = tk.Button(window, text="Save", width=10, command=save_task,bg='teal',font=('Arial',12))
button_save.pack(side=tk.LEFT, padx=5, pady=5)

button_exit = tk.Button(window, text="Close",width=10, command=exit_application,bg='grey',font=('Arial',12))
